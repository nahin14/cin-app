...
@section('content')
    ...
    {!! Form::model($solicitor, ['url' => 'solicitors/' . $solicitor->slug, 'method' => 'PATCH']) !!}
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit Solicitor</div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            {!! Form::submit('Update Solicitor', ['class' => 'btn btn-primary']) !!}
                        </div>
